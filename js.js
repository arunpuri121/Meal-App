// makes favourites meal array if it does not exist in local storage
if (localStorage.getItem("favouritesList") == null) {
    localStorage.setItem("favouritesList", JSON.stringify([]));
}

// fetches meals from api and return it
...
// show's all meals card in main section as per the search input value
...
//displays full meal details in main section
...
// displays all the fav meals in fav section
...
//addition ans substraction of meal from fav list
